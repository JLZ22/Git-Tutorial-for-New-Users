...
4. And you're done! Now, you can run all git commands without needing to authorize them every time. Note: this is <ins>**not recommended**</ins> if you are working on a <ins>**shared/temporary machine**</ins> because it grants <ins>**unlimited access**</ins> indefinetly.
